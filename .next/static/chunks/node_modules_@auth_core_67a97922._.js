...
function GitHub(config) {
    var _config_enterprise, _config_enterprise1, _config_enterprise2;
    var _config_enterprise_baseUrl;
    const baseUrl = (_config_enterprise_baseUrl = config === null || config === void 0 ? void 0 : (_config_enterprise = config.enterprise) === null || _config_enterprise === void 0 ? void 0 : _config_enterprise.baseUrl) !== null && _config_enterprise_baseUrl !== void 0 ? _config_enterprise_baseUrl : "https://github.com";
    const apiBaseUrl = (config === null || config === void 0 ? void 0 : (_config_enterprise1 = config.enterprise) === null || _config_enterprise1 === void 0 ? void 0 : _config_enterprise1.baseUrl) ? "".concat(config === null || config === void 0 ? void 0 : (_config_enterprise2 = config.enterprise) === null || _config_enterprise2 === void 0 ? void 0 : _config_enterprise2.baseUrl, "/api/v3") : "https://api.github.com";
    return {
        id: "github",
        name: "GitHub",
        type: "oauth",
        authorization: {
            url: "".concat(baseUrl, "/login/oauth/authorize"),
            params: {
                scope: "read:user user:email"
            }
        },
        token: "".concat(baseUrl, "/login/oauth/access_token"),
        userinfo: {
            url: "".concat(apiBaseUrl, "/user"),
            async request (param) {
                let { tokens, provider } = param;
                var _provider_userinfo;
                const profile = await fetch((_provider_userinfo = provider.userinfo) === null || _provider_userinfo === void 0 ? void 0 : _provider_userinfo.url, {
                    headers: {
                ...
                if (!profile.email) {
                    ...
                    const res = await fetch("".concat(apiBaseUrl, "/user/emails"), {
                        headers: {
                            Authorization: "Bearer ".concat(tokens.access_token),
                            "User-Agent": "authjs"
                        }
                    ...
                    if (res.ok) {
                        ...
                        var _emails_find;
                        profile.email = ((_emails_find = emails.find((e)=>e.primary)) !== null && _emails_find !== void 0 ? _emails_find : emails[0]).email;
                    }
                }
                return profile;
            }
        ...
        profile (profile) {
            ...
            return {
                ...
                name: (_profile_name = profile.name) !== null && _profile_name !== void 0 ? _profile_name : profile.login,
                email: profile.email,
